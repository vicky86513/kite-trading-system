...
Automatically resolves the near-month Crude Oil futures contract on MCX
(no need to hardcode the expiry each month). Writes to crude_oil_price_book.*
...
def run_tracker():
    ...
    tracker_config = config.FUTURES_TRACKERS["mcx_crude_oil"]
